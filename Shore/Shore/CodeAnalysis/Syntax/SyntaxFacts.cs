    ...
    public static class SyntaxFacts
    {
        ...
        public static TokType GetKeywordType(this string text)
        {
            return text switch
            {
                ...
                "bool{}" => TokType.BoolDictKeyword,
                "string{}" => TokType.StringDictKeyword,
                "int{}" => TokType.IntDictKeyword,
                "float{}" => TokType.FloatDictKeyword,
        ...
        public static string? GetText(TokType type)
        {
            return type switch
            {
                ...
                TokType.BoolDictKeyword => "bool{}",
                TokType.StringDictKeyword => "string{}",
                TokType.IntDictKeyword => "int{}",
                TokType.FloatDictKeyword => "float{}",
